...
- sourcePath: D:\dxl\szkj\knowledge-server\storage\raw\crawler\crawl-20260624062850-s95mj4\source-policy-jzbdwf\detail-01.html
...
```json
{
  ...
  "summary": "该指南详细规定了浙江省自然资源厅在处理政府信息公开申请时的原则、范围和流程。涉及主动公开的信息类型，以及依申请公开的程序，包括申请方式、受理机构及如何处理申请。",
  "isPolicyLike": true,
